...
import { Color, Group, InstancedMesh, Sprite, Points, Line, LineLoop, LineSegments, LOD, Mesh, SkinnedMesh, Bone, Skeleton, Shape, Fog, FogExp2 } from "three";
...
class OpenSimLoader extends ObjectLoader {
    ...
    async loadGLTFAsync(url, onProgress) {
