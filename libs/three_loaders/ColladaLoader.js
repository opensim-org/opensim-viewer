        ...
        parse(text, path) {
            ...
            function parseAnimation(xml) {
                ...
                if (hasChildren === false) {
                    ...
                    library.animations[
                        xml.getAttribute("id") || THREE.MathUtils.generateUUID()
                    ] = data;
                }
            }
            ...
            function buildAnimation(data) {
                ...
                for (const target in channels) {
                    if (channels.hasOwnProperty(target)) {
                        ...
                        const animation = buildAnimationChannel(
                            channel,
                            inputSource,
                            outputSource
                        );
            ...
            function buildAnimationChannel(channel, inputSource, outputSource) {
                ...
                switch (transform) {
                    case "matrix":
                        for (
                            i = 0, il = inputSource.array.length;
                            i < il;
                            i++
                        ) {
                            ...
                            if (channel.arraySyntax === true) {
                                ...
                                const index =
                                    channel.indices[0] + 4 * channel.indices[1];
                                data[time][index] = value;
                            } else {
                                for (
                                    j = 0, jl = outputSource.stride;
                                    j < jl;
                                    j++
                                ) {
                                    data[time][j] =
                                        outputSource.array[stride + j];
                                }
                            }
                        }
                ...
                for (let i = 0, l = xml.childNodes.length; i < l; i++) {
                    ...
                    switch (child.nodeName) {
                        case "bind_shape_matrix":
                            data.bindShapeMatrix = parseFloats(
                                child.textContent
                            );
                            break;
            ...
            function parseEffectParameters(xml) {
                ...
                for (let i = 0, l = xml.childNodes.length; i < l; i++) {
                    ...
                    switch (child.nodeName) {
                        ...
                        case "transparent":
                            data[child.nodeName] = {
                                opaque: child.hasAttribute("opaque")
                                    ? child.getAttribute("opaque")
                                    : "A_ONE",
            ...
            function parseEffectParameter(xml) {
                ...
                for (let i = 0, l = xml.childNodes.length; i < l; i++) {
                    ...
                    switch (child.nodeName) {
                        case "color":
                            data[child.nodeName] = parseFloats(
                                child.textContent
                            );
                            break;

                        case "float":
                            data[child.nodeName] = parseFloat(
                                child.textContent
                            );
                            break;
                    ...
                    switch (child.nodeName) {
                        ...
                        case "wrapV":
                            ...
                            if (child.textContent.toUpperCase() === "TRUE") {
                                ...
                                child.textContent.toUpperCase() === "FALSE"
                            ) {
                        ...
                        case "bump":
                            data[child.nodeName] =
                                parseEffectExtraTechniqueBump(child);
                            break;
                    }
                }
            }
            ...
            function buildMaterial(data) {
                ...
                function getTexture(textureObject, encoding = null) {
                    ...
                    if (image !== null) {
                        ...
                        if (loader !== undefined) {
                            ...
                            console.warn(
                                "THREE.ColladaLoader: THREE.Loader for texture %s not found.",
                                image
                            );
                            return null;
                        }
                ...
                for (const key in parameters) {
                    ...
                    switch (key) {
                        ...
                        case "specular":
                            ...
                            if (parameter.texture)
                                material.specularMap = getTexture(
                                    parameter.texture
                                );
                            break;
                        ...
                        case "emission":
                            ...
                            if (parameter.texture)
                                material.emissiveMap = getTexture(
                                    parameter.texture,
                                    THREE.sRGBEncoding
                                );
                            break;
                ...
                if (transparent && transparency) {
                    ...
                    if (transparent.data.texture) {
                        ...
                        switch (transparent.opaque) {
                            case "A_ONE":
                                material.opacity =
                                    color[3] * transparency.float;
                                break;

                            case "RGB_ZERO":
                                material.opacity =
                                    1 - color[0] * transparency.float;
                                break;

                            case "A_ZERO":
                                material.opacity =
                                    1 - color[3] * transparency.float;
                                break;

                            case "RGB_ONE":
                                material.opacity =
                                    color[0] * transparency.float;
                                break;
                ...
                if (
                    technique.extra !== undefined &&
                    technique.extra.technique !== undefined
                ) {
            ...
            function parseSource(xml) {
                ...
                for (let i = 0; i < xml.childNodes.length; i++) {
                    ...
                    switch (child.nodeName) {
                        ...
                        case "technique_common":
                            const accessor = getElementsByTagName(
                                child,
                                "accessor"
                            )[0];
                ...
                for (let i = 0, l = xml.childNodes.length; i < l; i++) {
                    ...
                    switch (child.nodeName) {
                        case "input":
                            ...
                            const inputname =
                                set > 0 ? semantic + set : semantic;
                            primitive.inputs[inputname] = {
                                id: id,
                                offset: offset,
                            };
                            primitive.stride = Math.max(
                                primitive.stride,
                                offset + 1
                            );
                        ...
                        case "polylist":
                            for (let g = 0; g < primitive.count; g++) {
                                ...
                                switch (vc) {
                                    ...
                                    default: // polylist with more than four vertices
                                        count += (vc - 2) * 3;
                    ...
                    switch (child.nodeName) {
                        case "attachment_full":
                            data.attachments.push(
                                parseKinematicsAttachment(child)
                            );
                            break;
                        ...
                        case "rotate":
                            data.transforms.push(
                                parseKinematicsTransform(child)
                            );
                            break;
                    }
                }
            ...
            function parseKinematicsBindJointAxis(xml) {
                ...
                for (let i = 0; i < xml.childNodes.length; i++) {
                    ...
                    switch (child.nodeName) {
                        case "axis":
                            const param =
                                child.getElementsByTagName("param")[0];
                            data.axis = param.textContent;
                            const tmpJointIndex = data.axis
                                .split("inst_")
                                .pop()
                                .split("axis")[0];
                            data.jointIndex = tmpJointIndex.substring(
                                0,
            ...
            function setupKinematics() {
                const kinematicsModelId = Object.keys(
                    library.kinematicsModels
                )[0];
                const kinematicsSceneId = Object.keys(
                ...
                for (let i = 0, l = bindJointAxis.length; i < l; i++) {
                    ...
                    const targetElement = collada.querySelector(
                        '[sid="' + axis.target + '"]'
                    );
                ...
                function connect(jointIndex, visualElement) {
                    const visualElementName =
                        visualElement.getAttribute("name");
            ...
            function buildObjects(geometries, instanceMaterials) {
                ...
                for (const type in geometries) {
                    ...
                    const materials = resolveMaterialBinding(
                    ...
                    const skinning =
                        geometry.data.attributes.skinIndex !== undefined; // choose between a single or multi materials (material array)

                    const material =
                        materials.length === 1 ? materials[0] : materials; // now create a specific 3D object
            ...
            function parseScene(xml) {
                const instance = getElementsByTagName(
                    xml,
                ...
                if (isEmpty(clips) === true) {
                    if (isEmpty(library.animations) === false) {
                        ...
                        for (const id in library.animations) {
                            ...
                            for (
                                let i = 0, l = animationTracks.length;
                                i < l;
                                i++
                            ) {
            ...
            if (parserError !== undefined) {
                ...
                const errorElement = getElementsByTagName(
                    parserError,
                    "div"
                )[0];
                let errorText;
