    ...
    class VRMLLoader extends THREE.Loader {
        ...
        parse(data, path) {
            ...
            function createTokens() {
                ...
                const tokens = [
                    WhiteSpace, // keywords appear before the Identifier
                    NodeName,
                    DEF,
                    USE,
                    ROUTE,
                    ...
                    TrueLiteral,
                    FalseLiteral,
                    NullLiteral, // the Identifier must appear after the keywords because all keywords are valid identifiers
                    Version,
                    Identifier,
                    RouteIdentifier,
                    StringLiteral,
            ...
            function createVisitor(BaseVRMLVisitor) {
                ...
                function processField(scope, ctx) {
                    ...
                    if (ctx.StringLiteral) {
                        ...
                        for (
                            let i = 0, l = ctx.StringLiteral.length;
                            i < l;
                            i++
                        ) {
                            const stringLiteral = ctx.StringLiteral[i];
                            field.values.push(
                                stringLiteral.image.replace(/'|"/g, "")
                            );
                        }
                    }
                    ...
                    if (ctx.NumberLiteral) {
                        ...
                        for (
                            let i = 0, l = ctx.NumberLiteral.length;
                            i < l;
                            i++
                        ) {
                    ...
                    if (ctx.TrueLiteral) {
                        ...
                        for (
                            let i = 0, l = ctx.TrueLiteral.length;
                            i < l;
                            i++
                        ) {
                    ...
                    if (ctx.FalseLiteral) {
                        ...
                        for (
                            let i = 0, l = ctx.FalseLiteral.length;
                            i < l;
                            i++
                        ) {
            ...
            function buildNode(node) {
                ...
                if (
                    build !== undefined &&
                    node.DEF !== undefined &&
                    build.hasOwnProperty("name") === true
                ) {
                    build.name = node.DEF;
                }
            ...
            function buildGroupingNode(node) {
                ...
                for (let i = 0, l = fields.length; i < l; i++) {
                    ...
                    switch (fieldName) {
                        ...
                        default:
                            console.warn(
                                "THREE.VRMLLoader: Unknown field:",
                                fieldName
                            );
                            break;
                    }
                ...
                for (let i = 0, l = fields.length; i < l; i++) {
                    ...
                    switch (fieldName) {
                        case "image":
                            ...
                            for (
                                let j = 3, k = 0, jl = fieldValues.length;
                                j < jl;
                                j++, k++
                            ) {
                                parseHexColor(
            ...
            function buildIndexedFaceSetNode(node) {
                ...
                const triangulatedCoordIndex = triangulateFaceIndex(
                    coordIndex,
                    ccw
                );
                let colorAttribute;
                ...
                if (color) {
                    if (colorPerVertex === true) {
                        if (colorIndex && colorIndex.length > 0) {
                            ...
                            const triangulatedColorIndex = triangulateFaceIndex(
                                colorIndex,
                                ccw
                            );
                        ...
                        if (colorIndex && colorIndex.length > 0) {
                            ...
                            const flattenFaceColors = flattenData(
                                color,
                                colorIndex
                            );
                            const triangulatedFaceColors = triangulateFaceData(
                                flattenFaceColors,
                                coordIndex
                            );
                ...
                if (normal) {
                    if (normalPerVertex === true) {
                        ...
                        if (normalIndex && normalIndex.length > 0) {
                            ...
                            const triangulatedNormalIndex =
                                triangulateFaceIndex(normalIndex, ccw);
                        ...
                        if (normalIndex && normalIndex.length > 0) {
                            ...
                            const flattenFaceNormals = flattenData(
                                normal,
                                normalIndex
                            );
                            const triangulatedFaceNormals = triangulateFaceData(
                                flattenFaceNormals,
                                coordIndex
                            );
                ...
                if (texCoord) {
                    ...
                    if (texCoordIndex && texCoordIndex.length > 0) {
                        ...
                        const triangulatedTexCoordIndex = triangulateFaceIndex(
                            texCoordIndex,
                            ccw
                        );
                ...
                const positionAttribute = toNonIndexedAttribute(
                    triangulatedCoordIndex,
                ...
                if (color) {
                    if (colorPerVertex === true) {
                        if (colorIndex.length > 0) {
                            ...
                            const expandedColorIndex =
                                expandLineIndex(colorIndex); // compute colors for each line segment (rendering primitve)
                        ...
                        if (colorIndex.length > 0) {
                            ...
                            const flattenLineColors = flattenData(
                                color,
                                colorIndex
                            ); // compute colors for each VRML primitve

                            const expandedLineColors = expandLineData(
                                flattenLineColors,
                                coordIndex
            ...
            function buildElevationGridNode(node) {
                ...
                const uvAttribute = toNonIndexedAttribute(
                    indices,
                ...
                if (normal) {
                    if (normalPerVertex === false) {
                        ...
                        normalAttribute = new THREE.Float32BufferAttribute(
                            normals,
                            3
                        );
                    } else {
                ...
                if (colorAttribute)
                    geometry.setAttribute("color", colorAttribute); // "solid" influences the material so let's store it for later use
            ...
            function buildExtrusionNode(node) {
                ...
                const crossSectionClosed =
                    ...
                    crossSection[1] === crossSection[crossSection.length - 1]; // vertices
                ...
                for (
                    let i = 0, j = 0, o = 0, il = spine.length;
                    i < il;
                    i += 3, j += 2, o += 4
                ) {
                ...
                if (beginCap === true || endCap === true) {
                    ...
                    if (endCap === true) {
                        const indexOffset =
                            crossSectionCount * (spineCount - 1); // references to the first vertex of the last cross section
                ...
                const normalAttribute = computeNormalAttribute(
                    indices,
                    vertices,
                    creaseAngle
                );
            ...
            function resolveUSE(identifier) {
                ...
                return build.isObject3D || build.isMaterial
                    ? build.clone()
                    : build;
            }
            ...
            function computeNormalAttribute(index, coord, creaseAngle) {
                ...
                for (let i = 0, l = faces.length; i < l; i++) {
                    const face = faces[i];
                    const nA = weightedNormal(
                        vertexNormals[face.a],
                        face.normal,
                        creaseAngle
                    );
                    const nB = weightedNormal(
                        vertexNormals[face.b],
                        face.normal,
                        creaseAngle
                    );
                    const nC = weightedNormal(
                ...
                for (let i = 0; i < indices.count; i++) {
                    ...
                    for (let j = 1; j < thresholds.length; j++) {
                        ...
                        if (topDown === true) {
                            ...
                            if (
                                position.y <= thresholdA.y &&
                                position.y > thresholdB.y
                            ) {
                                t =
            ...
            textureLoader
                ...
                .setCrossOrigin(this.crossOrigin); // check version (only 2.0 is supported)

            if (data.indexOf("#VRML V2.0") === -1) {
                throw Error(
                    "THREE.VRMLLexer: Version of VRML asset not supported."
                );
